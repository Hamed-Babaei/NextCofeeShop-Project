      ...
      <div className="container-fluid footer text-white mt-5 pt-5 px-0 position-relative overlay-top">
        <div className="row mx-0 pt-5 px-sm-3 px-lg-5 mt-4">
          <div className="col-lg-3 col-md-6 mb-5">
            ...
            <p>
              <i className="fa fa-phone-alt mr-2"></i>+939 170 9305
            </p>
            <p className="m-0">
              <i className="fa fa-envelope mr-2"></i>dev.hamedbabaei@gmail.com
            </p>
          </div>
          <div className="col-lg-3 col-md-6 mb-5">
            <h4
        ...
        <div
          ...
          style={{ border_color: "rgba(256 256, 256, .1) !important" }}
        >
